...
import { PRODUCTION_STATUS_LABEL } from "@/lib/production-status-style";

const ALL_VALUE = "__all__";

// factory_status is a fixed, small, code-level enum (see enums.ts) — no
// lookup-table fetch needed, unlike the job-status filter's DB-driven list.
const STATUS_OPTIONS = Object.entries(PRODUCTION_STATUS_LABEL);
