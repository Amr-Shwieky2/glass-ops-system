...
import { listQuotes, isQuoteStatus } from "@/server/quotes/queries";
...
export const metadata: Metadata = { title: "عروض الأسعار | نظام إدارة عمليات الزجاج" };
...
export default async function QuotesPage({
  ...
  const status = params.status && isQuoteStatus(params.status) ? params.status : undefined;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {total} {total === 1 ? "عرض سعر" : "عروض أسعار"}
        </p>
      </div>
      ...
      <form method="GET" className="flex flex-wrap gap-2">
        <div className="relative max-w-md flex-1">
          ...
          <Input
            ...
            placeholder="ابحث برقم العرض أو رقم المهمة أو اسم العميل..."
            className="ps-9"
          />
        </div>
