 ...
 * broke JSON parsing). Content quality on a 3B model is still modest
 * (occasional stray words in another language), which is exactly why
 * this feature is draft-assist only, reviewed by a human before saving.
